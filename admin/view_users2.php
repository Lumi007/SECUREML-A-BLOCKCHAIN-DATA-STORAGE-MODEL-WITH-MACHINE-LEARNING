...
if(isset($_POST['checkbox'])){
   ...
   $bd = urlencode('Congratulations '.$name.', we are pleased to inform you that your registration in the '.$department.' department is completed. Your Registration Number is '.$regno);
   file_get_contents("https://www.bulksmsnigeria.com/api/v1/sms/create?api_token=0NHYGfiCNxlbb6rP00bTtKoGd3KZ8vckE28f0ansI7Dvzvx8ZYgYSm8SpS3r&from=feespaymentPortl&to=".$email."&body=".$bd);
          ...
          <form method="POST" action="">
            ...
            ?>
                ...
                <tr>
                 ...
                 <td><a href='<?php echo"idcard.php?asjajs666uassa&asyuusas7&idcard=".$id2[$i]."&asjajs666uassa&asyuusas7&asasjyt6"; ?>'>Generate</a></td>
                </tr>
                  <?php
                  }}
                  ?>
